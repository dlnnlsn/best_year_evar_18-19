...
\vspace{6pt}
\item % The Andrew
Let $\mathbb{P}$ be the set of points in the Euclidean plane, and $O \in \mathbb{P}$ be a given point. Let $\mathbb{P}_O = \mathbb{P} \backslash \{O\}$ be the set of points in the Euclidean plane excluding $O$.
