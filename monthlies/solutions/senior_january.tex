...
Let the circumcircle of $ARQ$ and the circumcenter of $BPR$ intersect at $O$. Then we have that $\angle QOR = 180^\circ - \angle A$ and $\angle ROP = 180^\circ - \angle B$. It follows that $\angle POQ = 360^\circ - (180^\circ - \angle A) - (180^\circ - \angle B) = \angle A + \angle B = 180^\circ - \angle C$, and so $O$ lies on the circumcircle of $CQP$.
